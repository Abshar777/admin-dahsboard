  ...
  return (
    <>
      <PageContainer scrollable={true}>
        <div className="flex flex-1 pb-4 flex-col space-y-4">
          ...
          <div className="flex flex-col gap-3">
            {!isPending &&
              ...
              (
                ...
                <div
                  className="w-full h-[23rem] relative bg-muted-foreground/5 rounded-xl px-4 py-3 flex flex-col gap-2"
                  key={e._id}
                >
                  ...
                  <div className="overflow-hidden " ref={emblaRef}>
                    <div className="flex w-full relative    ">
                      {e.products.map((product) => (
                        <div
                          key={product._id}
                          className="p-1  relative flex-shrink-0 min-w-[20%] max-w-[20%]"
                        >
                          <ProductCard
                            //   key={product._id}

...
export default function ProductCard({  imageUrl ,onClick,className}: GlobalCardProps) {
  return (
    <div onClick={()=>onClick&&onClick()} className={cn(className,"bg-muted/20 mx-2 h-full  rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:scale-[.95]")}>
      ...
      <div className="p-4">
        <h2 className="text-xl font-semibold capit mb-2">aaa</h2>
        <p className=" text-sm mb-4 line-clamp-2">aaaa</p>
